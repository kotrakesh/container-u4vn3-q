...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-u4vn3-q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-u4vn3-q.containers.anotherwebservice.com/
...
```
git clone git@github.com:kotrakesh/container-u4vn3-q.git
cd container-u4vn3-q
```
...
```
docker attach container-u4vn3-q
```
